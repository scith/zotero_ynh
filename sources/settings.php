...
$API_key = 'YNHAPIKEY';      // obtain from https://www.zotero.org/settings/keys [no default]
$user_ID = 'YNHUSERID';      // obtain from https://www.zotero.org/settings/keys [no default]

// Basic Auth credentials to sync documents from Zotero
$basicauthname = 'YNHAUTHNAME';
$basicauthpass = 'YNHAUTHPASS';
...
$data_dir  = 'zotero';     // [default="data/zotero"]; directory with sync data, either relative to the script's location or absolute path (on the same server though!). (NB: due to the way zotero sync works, this path ends most definetely in "/zotero)
